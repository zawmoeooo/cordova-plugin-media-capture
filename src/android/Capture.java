...
//    }
    ...
    private boolean isMissingStoragePermissions(Request req, String mediaPermission) {
    ...
    private void captureAudio(Request req) {
        if (isMissingStoragePermissions(req, Manifest.permission.READ_MEDIA_AUDIO)) return;
